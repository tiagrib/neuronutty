# Notes from NeuroNutty
This code was included directly because the [original repository](https://github.com/facebookresearch/fairmotion) has been archived.

The code used here is based on a snapshot of the original Repo from May 17, 2024, and has been modified to better support the needs of NeuroNutty.
However, the original License was kept.
Please find below the original Readme from the Fairmotion repo.
